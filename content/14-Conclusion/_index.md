...
- Add images to your notes. Enable storage via Amplify Studio, then use [Amplify JS Library](https://docs.amplify.aws/lib/storage/getting-started/q/platform/js/) to access the images in your application.
